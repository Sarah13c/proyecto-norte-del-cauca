...
export function Traffic({ chartSeries, labels, sx }) {
  ...
  return (
    <Card sx={sx}>
      <CardHeader title={<Typography variant="h6" sx={{ fontFamily: 'Khula, sans-serif', fontWeight: 'bold' }}>Navegación</Typography>} />
      <CardContent>
        <Stack spacing={2}>
            ...
            {chartSeries.map((item, index) => {
              ...
              return (
                <Stack key={label} spacing={1} sx={{ alignItems: 'center' }}>
                  ...
                  <Typography variant="h6" sx={{ fontFamily: 'Khula, sans-serif', fontWeight: 'bold' }}>{label}</Typography>
